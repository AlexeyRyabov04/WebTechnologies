...
import by.bsuir.main.task16.AuthorTitlePriceComparator;
...
class AuthorTitlePriceComparatorTest {
    ...
    @Test
    void compare_GiveBooksWithAllSameAuthorsAndAllSameTitlesAndDifferentPrices_ReturnListSortedByPrice() {
        List<Book> books = new ArrayList<>();
        books.add(new Book("123456", "Автор 3", 20, "B124"));
        books.add(new Book("123456", "Автор 3", 25, "A234"));
        books.add(new Book("123456", "Автор 3", 15, "C453"));
        books.add(new Book("123456", "Автор 3", 30, "C453"));
        books.add(new Book("123456", "Автор 3", 35, "B124"));
        List<Book> expected = new ArrayList<>(List.of
                (books.get(2), books.get(0), books.get(1), books.get(3), books.get(4))
        );
        books.sort(new AuthorTitlePriceComparator());
        assertArrayEquals(expected.toArray(), books.toArray());
    }
    ...
    @Test
    void compare_GiveBooksWithAllSameAuthorsAndAllSameTitlesAndAllSamePrice_ReturnSameList() {
        List<Book> books = new ArrayList<>();
        books.add(new Book("123456", "Автор 1", 20, "B124"));
        books.add(new Book("123456", "Автор 1", 20, "A234"));
        books.add(new Book("123456", "Автор 1", 20, "C453"));
        books.add(new Book("123456", "Автор 1", 20, "C453"));
        books.add(new Book("123456", "Автор 1", 20, "B124"));
        List<Book> expected = new ArrayList<>(List.of
